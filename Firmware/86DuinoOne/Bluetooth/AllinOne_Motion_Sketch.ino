...
void loop()
{
  if(Serial1.available()){ Serial1_Command = Serial1.read(); } else { Serial1_Command = 0xFFF; }
  if(Serial2.available()){ Serial2_Command = Serial2.read(); } else { Serial2_Command = 0xFFF; }
